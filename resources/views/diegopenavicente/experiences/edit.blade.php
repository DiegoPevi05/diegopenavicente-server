            ...
            <div class="col-12 col-md-6">
                <div class="form-group my-2 ">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror" id="is_active" name="is_active" {{ old('is_active', $experience->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-group my-2">
                    ...
                    <input type="date" class="form-control @error('startDate') is-invalid @enderror" id="startDate" name="startDate" value="{{ old('startDate',$experience->startDate) }}">
                    @error('startDate')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group my-2">
                    ...
                    <input type="date" class="form-control @error('endDate') is-invalid @enderror" id="endDate" name="endDate" value="{{ old('endDate',$experience->endDate) }}">
                    @error('endDate')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group my-2">
                    ...
                    @if($experience->image1) 
                        <div class="m-2">
                            <img src="{{env('BACKEND_URL_IMAGE')}}{{ $experience->image1 }}" class="rounded flex-start border border-5 border-indigo" style="height: 200px;" alt="image1">
                        </div>
                    @else
                        <div>
                ...
                <div class="form-group my-2">
                    ...
                    @if($experience->image2) 
                        <div class="m-2">
                            <img src="{{env('BACKEND_URL_IMAGE')}}{{ $experience->image2 }}" class="rounded flex-start border border-5 border-indigo" style="height: 200px;" alt="image2">
                        </div>
                    @else
                        <div>
                            <label for="img" class="my-2">No hay imagen de experiencia previamente cargada</label>
                ...
                <div class="form-group my-2">
                    ...
                    @if($experience->image3) 
                        <div class="m-2">
                            <img src="{{env('BACKEND_URL_IMAGE')}}{{ $experience->image3 }}" class="rounded flex-start border border-5 border-indigo" style="height: 200px;" alt="image3">
                        </div>
                    @else
                        <div>
                            <label for="img" class="my-2">No hay imagen de experiencia previamente cargada</label>
                ...
                <div class="form-group my-2">
                    ...
                    @if($experience->image4) 
                        <div class="m-2">
                            <img src="{{env('BACKEND_URL_IMAGE')}}{{ $experience->image4 }}" class="rounded flex-start border border-5 border-indigo" style="height: 200px;" alt="image4">
                        </div>
                    @else
                        <div>
                            <label for="img" class="my-2">No hay imagen de experiencia previamente cargada</label>
                ...
                <div class="d-flex justify-content-start my-4">
                    <button type="submit" class="btn btn-indigo w-auto">Actualizar Experiencia</button>
                </div>   
            </div>
        </form>
        </div>
