...
@section('content')
    ...
    @if ($project)
        ...
        <form method="POST" action="{{ route('diegopenavicente.projects.update',$project) }}" class="row flex-column flex-md-row" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12 col-md-6">
                ...
                <div class="form-group my-2">
                    ...
                    <textarea class="form-control @error('description_es') is-invalid @enderror" id="description_es" name="description_es" rows="3">{{ old('description_es',$project->description_es) }}</textarea>
                ...
                <div class="form-group my-2">
                    ...
                    <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="3">{{ old('description_en',$project->description_en) }}</textarea>
                ...
                <div class="form-group my-2">
                    ...
                    <textarea class="form-control @error('description_it') is-invalid @enderror" id="description_it" name="description_it" rows="3">{{ old('description_it',$project->description_it) }}</textarea>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group my-2">
                    ...
                    @if($project->logo) 
                        <div class="m-2">
                            <img src="{{env('BACKEND_URL_IMAGE')}}{{ $project->logo }}" class="rounded flex-start border border-5 border-indigo" style="height: 200px;" alt="image4">
                        </div>
                    @else
                        <div>
                            <label for="img" class="my-2">No hay imagen de proyecto previamente cargada</label>
                        </div>
                    @endif
                ...
                <div class="d-flex justify-content-start my-4">
                    <button type="submit" class="btn btn-indigo w-auto">Actualizar Proyecto</button>
                </div>  
            </div>
        </form>
        </div>
        ...
        <div class="row mt-3">
            <div class="row-5">
                <div class="alert alert-danger" role="alert">
                    "Hubo un error al intentar traer la información del proyecto"
                </div>
                <a href={{ route('diegopenavicente.projects.index') }} class="btn btn-primary">Voler a la lista de Proyectos</a>
            </div>
        </div>
    @endif
