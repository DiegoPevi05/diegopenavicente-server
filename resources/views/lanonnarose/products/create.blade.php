...
@section('content')
    ...
    <form method="POST" action="{{ route('lanonnarose.products.store') }}" class="row flex-column flex-md-row" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="col-12 col-md-6">
            ...
            <div class="form-group my-2">
                ...
                <input type="text" class="form-control @error('section_es') is-invalid @enderror" id="section_es" name="section_es" value="{{ old('section_es') }}">
                @error('section_es')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group my-2">
                ...
                <input type="text" class="form-control @error('section_en') is-invalid @enderror" id="section_en" name="section_en" value="{{ old('section_en') }}">
                @error('section_en')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group my-2">
                ...
                <input type="text" class="form-control @error('shortDescription_es') is-invalid @enderror" id="shortDescription_es" name="shortDescription_es" value="{{ old('shortDescription_es') }}">
            ...
            <div class="form-group my-2">
                ...
                <input type="text" class="form-control @error('shortDescription_en') is-invalid @enderror" id="shortDescription_en" name="shortDescription_en" value="{{ old('shortDescription_en') }}">
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="form-group my-2">
                <div class="d-flex flex-column col-12 ">
                    <label for="imageUrl" class="my-2">Imagen del Producto</label>
            ...
            <div class="d-flex justify-content-start my-4">
                <button type="submit" class="btn btn-indigo w-auto">Crear Producto</button>
            </div>  
        </div>
    </form>
    </div>
